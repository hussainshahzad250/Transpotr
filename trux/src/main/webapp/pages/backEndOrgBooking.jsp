			...
			<form  action="backOrgBooking" method="post" class="form-inline" onsubmit="return validateForm();">
					...
					<div class="row" style="margin-top:-2%; ">                                        									                                  
						...
						<table id="Address" cellpadding="8" cellspacing="5">
							...
							<input type="button" value="+" onclick="addToAddressRow();" class="btn btn-danger btn-sm btn_nav1" title="Add the to address and phone number!"/>
							<input type="button" value="-" onclick="removToAddressRow();" class="btn btn-danger btn-sm btn_nav1" title="Remove the to address and phone number! "/>
						    <input type="submit" class="btn btn-danger btn-sm btn_nav1" onclick="" value="Book Now"> 
