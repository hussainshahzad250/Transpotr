...
<div class="container"  style="border-radius:10px 10px 7px 7px;">  
	<div class="row">    
    	...
    	<fieldset class="fieldset2 col-lg-12 borderManager">  <legend class="borderManager">Driver Reports</legend>
			<f:form commandName="driverFilter" action="dReports" method="post" cssClass="form-inline" ><!-- onsubmit="return appliedFromToDate();" -->
				
				 <div class="row" style="margin-top:-2%;">                                        									                                  
						<div class="col-lg-3 col-md-3 col-sm-12">
							<div style="margin-bottom:6px;">Driver Phone Number</div>
							<f:input path="driverPhoneNumber" id="driverPhoneNumber" cssClass="form-control input-sm fromToDateInputFields" cssStyle="width:80%;cursor: pointer;"  placeholder="Driver Phone Number"/>  
						</div>                                               
						<div class="col-lg-3 col-md-3 col-sm-12">
							<div style="margin-bottom:6px;">Driver Name</div>
							<f:input path="vehicleNumber" id="vehicleNumber"  cssClass="form-control input-sm" cssStyle="width:80%;cursor: pointer;" placeholder="Driver Name"/>  
						</div>
						<div class="col-lg-3 col-md-3 col-sm-12">
							<div style="margin-bottom:6px;">Vehicle Number</div>
							<f:input path="vehicleNumber" id="vehicleNumber"   cssClass="form-control input-sm" cssStyle="width:80%;cursor: pointer;" placeholder="Vehicle Number"/>   
						</div>	
						...
						<f:option value="Mapped">Mapped</f:option>
						<f:option value="Free">Free</f:option>
...
<script type="text/javascript">
    	$(document).ready(function() {
			...
			$('#LoggedInTableContainer').jtable({
				...
				actions : {
					listAction : '/trux/cdvr/driverReports?action=list',
				},
				fields : {
					dates : {
						title : 'Date',
