		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<fieldset class="fieldset2 col-lg-12 borderManager table-responsive">
					<legend class="borderManager">Back end booking ride search </legend>
					<p>
						<input type="hidden" id="time" readonly="readonly" class="input-sm">
					</p>
					 <f:form commandName="orderFilters" action="backendBookingRideFilterReports" method="post" cssClass="form-inline">
					...
					<f:form action="/trux/reportsapi/clearBackendBookinRide" method="get">
						<div class="col-lg-3 col-md-3 col-sm-12">
							<div
					 ...
					 <!--  <button onclick="return diffTwoDates()">d</button>  -->
				</fieldset>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<fieldset class="fieldset2 borderManager table-responsive">
				<a href="/trux/reportsapi/bookingRideXLSReports"
...
jQuery(document).ready(function() {	
  ...
  function timeDuration(data){
	...
	function dateStatusValidate(date){
		...
		$("#orderList").jqGrid({
			    url:'/trux/reportsapi/bookingRideGridRequest?action=list', 
			    datatype: 'json',
			    mtype: 'POST', 
			      ...
			      return true; 
		        	...
		        	onclickSubmit: function (rp_ge, postdata) { 
		        		rp_ge.url = '#?bookingId='+registrationNumber ;
			   	        alert("Booking Id  " +registrationNumber +" are  !");
		          }
			},			 
		    {sopt : [ 'cn', 'bw', 'ew' ],
			closeOnEscape : true,
