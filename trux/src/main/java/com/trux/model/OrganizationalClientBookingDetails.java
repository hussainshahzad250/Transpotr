...
@Entity
@Table(name="multi_drop_point_booking")
public class OrganizationalClientBookingDetails  implements Cloneable{
	...
	*/
	/*@Column(name="driverCall_datetime")*/
	@Transient
	...
	public OrganizationalClientBookingDetails() {
	}

	

	public OrganizationalClientBookingDetails(String customerName, String custmerPhonenumber,
			String customerEmail,  Double fromLat, Double fromLong,
			String fromLocation, Double toLat, Double toLong,
			String toLocation, Date createdDate, Date updatedDate, Integer bookingStatus, String vehicleType) {
		super();
	...
	public OrganizationalClientBookingDetails(String errorCode, String errorMessage) {
		super();
