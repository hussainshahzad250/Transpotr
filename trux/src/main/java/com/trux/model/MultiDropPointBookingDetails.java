...
public class MultiDropPointBookingDetails  implements Cloneable{
	...
	public MultiDropPointBookingDetails() {
	}
 

	public MultiDropPointBookingDetails(Integer bookingId, String customerId,
			String driverName, String driverPhonenumber, String expectedDistance) {
		super();
	...
	public MultiDropPointBookingDetails(String errorCode, String errorMessage) {
		super();
